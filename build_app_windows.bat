...
set JAVA_VERSION=19
set MAIN_JAR=txipironClient-%PROJECT_VERSION%.jar
...
"%JAVA_HOME%\bin\jdeps" ^
  ...
  --print-module-deps target\classes\eus\ehu\txipironesmastodonfx\TxipironClient.class > temp.txt
...
set manual_modules=,jdk.crypto.ec,jdk.localedata,java.xml,java.scripting,jdk.unsupported,javafx.controls,javafx.fxml,javafx.graphics,javafx.web
