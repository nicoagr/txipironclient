...
JAVA_VERSION=19
MAIN_JAR="txipironClient-$PROJECT_VERSION.jar"
...
detected_modules=`$JAVA_HOME/bin/jdeps \
  ...
  --class-path "target/installer/input/libs/*" \
    target/classes/eus/ehu/txipironesmastodonfx/TxipironClient.class`
...
--icon img/logo/darkImg/dark.icns \
--app-version ${APP_VERSION} \
--vendor "Txipirones SE Group (DIF-FISS), UPV/EHU" \
--copyright "Copyright © 2023 Txipirones UPV/EHU." \
--mac-package-identifier eus.ehu.txipironclient \
--mac-package-name TxipironClient